...
BEGIN
  ...
  -- Dedupe de duplo clique / reenvio
  ...
  -- A ligação SEMPRE é gravada no histórico em nome de quem ligou, mesmo que a
  -- fila já considerasse o contato encerrado (ex.: outro corretor finalizou antes).
