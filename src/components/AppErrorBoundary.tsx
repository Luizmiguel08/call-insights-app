        ...
        >
          <div className="max-w-md w-full text-center rounded-2xl border border-zinc-800 bg-[#13151e] p-8 space-y-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center rounded-md bg-[#c9a84c] px-4 py-2 text-sm font-semibold uppercase tracking-[0.2em] text-black hover:bg-[#d4b968] transition"
            >
              Recarregar
            </button>
          </div>
